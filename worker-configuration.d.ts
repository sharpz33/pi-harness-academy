/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=local --env-interface=CloudflareBindings` (hash: 652742f5d77039ca7482a46c0d5bdcee)
// Runtime types generated with workerd@1.20260910.1 2026-09-11 
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	EMAIL: SendEmail;
	APP_ORIGIN: "http://localhost:8787";
	AUTH_FROM: "login@local.invalid";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "AUTH_FROM">> {}
}
